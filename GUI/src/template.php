    ...
    <div>
            ...
            <div class="peers ai-c fxw-nw">
              <div class="peer peer-greed">
                <a class="sidebar-link td-n" href="index.php">
                  <div class="peers ai-c fxw-nw">
                    <div class="peer peer-greed">
                      <h5 class="lh-1 mB-0 logo-text"><img src="img/MARCELL_logo.png" width="240px"/></h5>
                    </div>
                  </div></a>
              </div>
              <div class="peer">
      ...
      <div class="page-container">
        <div class="header navbar">
          <div class="header-container">
            <ul class="nav-left">
              ...
              <li><a>MARCELL Sustainability Access Point</a></li>
            </ul>
        ...
        <footer class="bdT ta-c p-30 lh-0 fsz-sm c-grey-600">
          <span>Copyright © MARCELL Project. All rights reserved.
          </span>
        </footer>
      </div>
    </div>
