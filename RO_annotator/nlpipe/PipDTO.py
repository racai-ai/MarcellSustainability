...
class PipDTO(object):
    ...
    def getProcessedChars(self):
        return self._procchrs
    ...
    def addPerformedOp(self, op: str):
        if op in PipAlgo.getAvailableOperations():
            ...
            raise RuntimeError("Operation '" + op + "' is not a valid PipAlgo operation!")
